...
<body>
    <div class="container">
        ...
        <p>
            Your branch administrator account has been successfully created. Below are your login credentials and account details. Please keep them safe.
        </p>
        ...
        <div class="info-box">
            ...
            <p class="info-item"><strong>Role:</strong> {{ $user->role->role_name }}</p>
